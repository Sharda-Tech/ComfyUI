...
class SDXLRefiner(supported_models_base.BASE):
    ...
    def get_model(self, state_dict, prefix="", device=None,tile=False):
        return model_base.SDXLRefiner(self, device=device,tile=tile)
...
class SDXL(supported_models_base.BASE):
    ...
    def get_model(self, state_dict, prefix="", device=None, tile=False):
        return model_base.SDXL(self, model_type=self.model_type(state_dict, prefix), device=device,tile=tile)
